...
<aside class="fixed inset-y-0 left-0 w-64 bg-primary-bg text-slate-400 flex flex-col shadow-2xl z-50">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[2px] px-3 mb-4">Main Menu</p>
        
        <a href="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-blue-600 text-white shadow-md shadow-blue-600/20 transition-all">
        ...
        <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-slate-200 transition-all group">
            <i class="fa-solid fa-users w-5 group-hover:text-blue-400"></i>
            <span class="font-medium text-sm">Team Members</span>
        </a>
        
        <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-slate-200 transition-all group">
            <i class="fa-solid fa-layer-group w-5 group-hover:text-blue-400"></i>
            <span class="font-medium text-sm">Projects</span>
        </a>

        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-[2px] px-3 mt-8 mb-4">Settings</p>
